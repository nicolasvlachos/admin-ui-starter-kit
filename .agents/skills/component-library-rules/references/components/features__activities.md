...
examples:
  ...
  - RichDensityChangesMetadataActions
  - MassEventConfigurationCustomStringsTones
  - CustomRowRenderingSlotsRenderRow
  - ResourceRegistrySaveRestoreTaggingBadgingLinking
imports:
...
export function DefaultDensityHeadlineSegmentsGrouping() {
...
export function RichDensityChangesMetadataActions() {
	const [registry, setRegistry] =
	        useState<Record<string, ActivityResourceConfig>>(RESOURCE_SEED);
	const [, setLastEvent] = useState<string>('—');
	const recordEvent = (msg: string) => setLastEvent(msg);
	return (
		<>
			<ActivityFeedCard
...
export function MassEventConfigurationCustomStringsTones() {
	return (
		<>
			<ActivityFeedCard
			                    activities={[
...
export function CustomRowRenderingSlotsRenderRow() {
	return (
		<>
			<ActivityFeedCard
...
export function ResourceRegistrySaveRestoreTaggingBadgingLinking() {
	const [registry, setRegistry] =
	        useState<Record<string, ActivityResourceConfig>>(RESOURCE_SEED);
	const [, setLastEvent] = useState<string>('—');
	const recordEvent = (msg: string) => setLastEvent(msg);
