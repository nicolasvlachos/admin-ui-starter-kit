...
examples:
  ...
  - AiCodeBlockExample
  - AiAttachmentExample
  - AiInlineCitationExample
  - AiSourcesExample
  - AiReasoningExample
  - AiChainOfThoughtExample
  - AiTaskExample
  - AiArtifactExample
  - AiFileTreeExample
  - AiPackageInfoExample
  - AiConfirmationExample
imports:
  - @/components/composed/ai
