...
examples:
  ...
  - ButtonComboFeatures
  - LoaderButtonStates
  - LoaderButtonInteractive
  - TooltipButtonExample
  - GoogleButtonExample
  - ShopifyButtonExample
  - TextButtonSizes
  - PageActionButtonVariants
  - PageActionButtonSizes
  - RealisticToolbar
imports:
...
The base button family — BaseButton (variant × style × size), the higher-level Button (loader / tooltip / link wrapper), and specialty buttons (Google, Shopify, Text, PageAction).

**Layer:** `base`  
**Source:** `src/components/base/buttons`
