...
Drag-drop area + per-file progress rows + summary toolbar. Composes Dropzone and UploadProgressList. Framework-agnostic — the consumer drives the actual transfer.

**Layer:** `base`  
**Source:** `src/components/base/forms/fields`
