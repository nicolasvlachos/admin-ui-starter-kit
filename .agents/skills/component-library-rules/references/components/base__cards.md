...
examples:
  - Default
  - WithIconTooltipFooter
  - WithActions
  - AlertVariants
  - PaddingSizes
  - SurfaceVariants
  - HeaderSlots
  - HeaderAndFooterDividers
  - ExpandableUncontrolled
  - ExpandableCustomLabels
  - Skeleton
  - MetricKPICard
  - NotificationCard
...
The composed card primitive — header (icon, title, suffix, slots), optional alert, expandable body, footer text or slot, and three surface chromes.

**Layer:** `base`  
**Source:** `src/components/base/cards`
