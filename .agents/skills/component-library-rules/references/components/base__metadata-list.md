...
examples:
  - APISurface
  - Vertical2ColumnNoIcons
  - VerticalSingleColumnNoIcons
  - RowsTwoColumnWithHairlines
  - RowsReceiptStyle
  - RowsWithIconsTooltips
  - SectionedMultiCard
  - Dense4ColumnOverview
  - Example3ColumnWithIcons
  - HorizontalPillSummary
  - WithTitleSeparator
  - EmptyStateFallbacksCustomRenderers
imports:
  - @/components/base/badge
  - @/components/base/cards
  - @/components/base/display/avatar
  - @/components/base/display/metadata/metadata-list
...
Flexible label/value list for entity metadata. Three layouts (vertical grid, horizontal pills, two-column rows), per-item icons, tooltips, descriptions, and custom renderers — with first-class empty-state handling.

**Layer:** `base`  
**Source:** `src/components/base/display/metadata`
