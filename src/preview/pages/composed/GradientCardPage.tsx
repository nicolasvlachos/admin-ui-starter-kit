...
export default function GradientCardPage() {
	return (
		<PreviewPage title="Composed · Gradient card" description="Vivid gradient card with optional pattern, badge, alert, action.">
			<PreviewSection title="Hero card with action" span="full">
				<GradientCard
					gradient="coral"
					pattern="circles"
			...
			<PreviewSection title="Compact — all gradients" span="full">
			...
			<PreviewSection title="Hero variants" span="full">
