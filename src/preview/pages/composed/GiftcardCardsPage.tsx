...
export default function GiftcardCardsPage() {
	return (
		<PreviewPage title="Composed · Giftcard cards" description="Five visual variants — gradient, compact, minimal, dark, illustrated.">
			<PreviewSection title="Gradient (default)">
				<GiftcardCard
					code="GCT-A4B7-C9E2"
					amount="250.00 USD"
					status="active"
			...
			<PreviewSection title="Illustrated">
				<GiftcardCardIllustrated
					code="GCT-I1L2-U3S4"
					amount="350.00 USD"
					status="active"
			...
			<PreviewSection title="Compact (active + expired)" span="full">
