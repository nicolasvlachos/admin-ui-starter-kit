...
export default function OnboardingChecklistPage() {
	...
	return (
		...
		>
			<PreviewSection title="Bordered (default) — point-of-sale onboarding" span="full">
				<Col className="max-w-2xl">
					<OnboardingChecklist steps={onboardingSteps} />
				</Col>
			</PreviewSection>

			<PreviewSection title="Card variant — workspace setup, controlled" span="full">
				<Col className="max-w-2xl">
			...
			<PreviewSection title="Flat variant — minimal" span="full">
				<Col className="max-w-2xl">
					<OnboardingChecklist
