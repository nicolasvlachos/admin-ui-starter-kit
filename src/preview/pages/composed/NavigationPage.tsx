...
export default function NavigationPage() {
	return (
		<PreviewPage title="Composed · Navigation & boards" description="Kanban, tab switcher, time ruler, vendor performance, experience activity.">
			<PreviewSection title="Kanban micro board" span="full">
				<KanbanMicroBoard
					columns={[
			...
			<PreviewSection title="Tab switcher card">
				<TabSwitcherCard
					title="Gift Cards"
					tabs={{
						recent: [
			...
			<PreviewSection title="Time distribution ruler" span="full">
			...
			<PreviewSection title="Vendor performance">
				<VendorPerformanceCard
			...
			<PreviewSection title="Experience activity">
				<ExperienceActivityCard
					completed={2}
					total={5}
					activities={[
