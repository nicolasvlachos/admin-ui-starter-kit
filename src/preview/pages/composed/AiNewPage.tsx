...
export default function AiNewPage() {
	...
	return (
		...
		>
			<PreviewSection title="AiConfidenceCard">
				<AiConfidenceCard
					score={0.84}
					model="Claude 4.7"
					factors={[
			...
			<PreviewSection title="AiPromptSuggestions">
				<AiPromptSuggestions
					suggestions={[
			...
			<PreviewSection title="AiTokenUsageCard" span="full">
				<AiTokenUsageCard
					model="Claude 4.7"
					inputTokens={3240}
					outputTokens={812}
			...
			<PreviewSection title="AiMessageBubble" span="full">
			...
			<PreviewSection title="AiToolCall" span="full">
			...
			<PreviewSection title="AiCitation">
				<AiCitation
					defaultExpanded
					sources={[
						{
			...
			<PreviewSection title="AiFeedback">
