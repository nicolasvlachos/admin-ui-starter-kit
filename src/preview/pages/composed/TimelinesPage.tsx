...
export default function TimelinesPage() {
	return (
		...
		>
			...
			<PreviewSection title="Payment timeline" span="full">
				<PaymentTimelineCard
					events={[
			...
			<PreviewSection title="Activity stream — read-only tracking" span="full">
				<ActivityStreamCard
					items={[
			...
			<PreviewSection title="Changelog">
				<ChangelogTimelineCard
					entries={[
						{
							id: 'c1',
			...
			<PreviewSection title="Milestones">
				<MilestonesTimelineCard
					milestones={[
						{
							id: 'm1',
