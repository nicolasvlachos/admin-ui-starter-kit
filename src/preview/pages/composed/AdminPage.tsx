...
export default function AdminPage() {
	return (
		<PreviewPage title="Composed · Admin" description="Team list, permissions, conversations, settings, inventory.">
			<PreviewSection title="Team members" span="full">
				<SmartCard>
					<TeamMemberRow
						members={[
			...
			<PreviewSection title="Role permissions" span="full">
				<RolePermissionCard
					roleName="Editor"
			...
			<PreviewSection title="Recent conversations" span="full">
				<SmartCard>
			...
			<PreviewSection title="Settings toggles" span="full">
				<SettingsToggleRow
					settings={[
			...
			<PreviewSection title="Inventory level">
