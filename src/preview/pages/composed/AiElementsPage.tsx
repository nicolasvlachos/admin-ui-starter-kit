...
export default function AiElementsPage() {
	return (
		...
		>
			<PreviewSection title="AiShimmer">
			...
			<PreviewSection title="AiCodeBlock" span="full">
				<div className="flex flex-col gap-3">
			...
			<PreviewSection title="AiAttachment">
			...
			<PreviewSection title="AiInlineCitation">
				<Text>
			...
			<PreviewSection title="AiSources" span="full">
			...
			<PreviewSection title="AiReasoning" span="full">
				<div className="flex flex-col gap-3">
			...
			<PreviewSection title="AiChainOfThought" span="full">
				<AiChainOfThought
					streaming
					steps={[
						{
			...
			<PreviewSection title="AiTask" span="full">
				<AiTask
					density="expanded"
					task={{
						id: 'root',
			...
			<PreviewSection title="AiArtifact" span="full">
				<AiArtifact
					title="Counter.tsx"
			...
			<PreviewSection title="AiFileTree" span="full">
				<AiFileTree
					nodes={[
						{
							id: 'root',
			...
			<PreviewSection title="AiPackageInfo">
				<AiPackageInfo
			...
			<PreviewSection title="AiConfirmation" span="full">
				<div className="flex flex-col gap-3">
					<AiConfirmation
