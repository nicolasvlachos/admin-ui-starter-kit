...
export default function LayoutSidebarPage() {
	return (
		<PreviewPage title="Layout · Sidebar" description="Full app sidebar assembly plus reusable navigation, workspace, and footer item partials.">
			<PreviewSection title="AppSidebar shell" span="full">
			...
			<PreviewSection title="Navigation partials" span="full">
				<SidebarProvider defaultOpen className="min-h-0">
			...
			<PreviewSection title="Custom row renderer" span="full">
				<SidebarProvider defaultOpen className="min-h-0">
