...
export default function LayoutHeaderPage() {
	return (
		<PreviewPage title="Layout · Header" description="Topbar, breadcrumbs, command search, notifications, and action slots in a realistic app-shell canvas.">
			<PreviewSection title="App header composition" span="full">
			...
			<PreviewSection title="Header partials" span="full">
				<SidebarProvider className="min-h-0">
			...
			<PreviewSection title="Custom notification renderer" span="full">
