...
export default function LayoutUsersPage() {
	return (
		<PreviewPage title="Layout · Users & avatars" description="User identity surfaces used by layout headers, sidebars, menus, avatar groups, and status badges.">
			<PreviewSection title="Avatar states">
				<Row>
			...
			<PreviewSection title="Header user menu">
			...
			<PreviewSection title="Sidebar user menu" span="full">
				<SidebarProvider>
			...
			<PreviewSection title="Custom trigger + custom content" span="full">
